...
try {
    ...
    echo "✅ Test 1: Checking DriverNormalized with correct columns\n";
    ...
    $drivers = \App\Models\DriverNormalized::select('id', 'driver_id', 'first_name', 'surname', 'phone', 'email', 'residence_state_id', 'residence_lga_id')
