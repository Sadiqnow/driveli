...
class Drivers extends Authenticatable
{
    ...
    /**
     * Check if driver can perform KYC
     */
    // public function canPerformKyc(): bool
    // {
    //     return !in_array($this->kyc_status, ['completed']) &&
    //            ($this->kyc_retry_count < 3) &&
    //            !in_array($this->verification_status, ['verified']);
    // }
    ...
    /**
     * Reset KYC process (for rejected applications).
     */
    // public function resetKyc(string $reason = null): void
    // {
    //     $this->update([
    ...
    //     // Mark existing documents as rejected
    //     $this->documents()
    ...
    /**
     * Get KYC completion summary for admin.
     */
