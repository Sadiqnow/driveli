...
class StatesAndLGAsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $statesAndLGAs = [
            ...
            'EKITI' => [
                ...
                'lgas' => [
                    ...
                    'Gbonyin', 'Ido Osi', 'Ijero', 'Ikere', 'Ikole', 'Ilejemeji', 'Irepodun/Ifelodun',
                    'Ise/Orun', 'Moba', 'Oye'
                ]
            ],
            'ENUGU' => [
        ...
        foreach ($statesAndLGAs as $stateName => $stateData) {
            // Create the state
            $state = State::create([
                'name' => $stateName,
                'code' => $stateData['code']
            ...
            // Create local governments for this state
            ...
            $this->command->info("Created {$stateName} with " . count($stateData['lgas']) . " LGAs");
        }

        $this->command->info("Successfully seeded " . State::count() . " states and " . LocalGovernment::count() . " local governments");
    }
}