...
class RolePermissionSeeder extends Seeder
{
    ...
    private function assignPermissionsToRoles()
    {
        ...
        if ($adminRole) {
            $adminPermissions = [
                'view_dashboard',
                'manage_drivers', 'view_drivers', 'create_drivers', 'edit_drivers', 'verify_drivers', 'approve_drivers',
        ...
        if ($moderatorRole) {
            $moderatorPermissions = [
                'view_dashboard',
                'view_drivers', 'verify_drivers', 'approve_drivers',
        ...
        if ($viewerRole) {
            ...
            foreach ($viewerPermissions as $permissionName) {
                $permission = Permission::where('name', $permissionName)->first();
                if ($permission) {
                    $viewerRole->givePermission($permission);
                }
            }
