...
@section('content_header', 'Add New Company')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select multiple class="form-control @error('vehicle_types_needed') is-invalid @enderror" 
                                        ...
                                        <option value="Car" {{ in_array('Car', old('vehicle_types_needed', [])) ? 'selected' : '' }}>Car</option>
                                        <option value="Van" {{ in_array('Van', old('vehicle_types_needed', [])) ? 'selected' : '' }}>Van</option>
                                        <option value="Truck" {{ in_array('Truck', old('vehicle_types_needed', [])) ? 'selected' : '' }}>Truck</option>
                                        <option value="Bus" {{ in_array('Bus', old('vehicle_types_needed', [])) ? 'selected' : '' }}>Bus</option>
                                        <option value="Motorcycle" {{ in_array('Motorcycle', old('vehicle_types_needed', [])) ? 'selected' : '' }}>Motorcycle</option>
                                        <option value="Trailer" {{ in_array('Trailer', old('vehicle_types_needed', [])) ? 'selected' : '' }}>Trailer</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select multiple class="form-control @error('preferred_regions') is-invalid @enderror" 
                                        ...
                                        <option value="Lagos" {{ in_array('Lagos', old('preferred_regions', [])) ? 'selected' : '' }}>Lagos</option>
                                        <option value="Abuja" {{ in_array('Abuja', old('preferred_regions', [])) ? 'selected' : '' }}>Abuja</option>
                                        <option value="Kano" {{ in_array('Kano', old('preferred_regions', [])) ? 'selected' : '' }}>Kano</option>
                                        <option value="Ibadan" {{ in_array('Ibadan', old('preferred_regions', [])) ? 'selected' : '' }}>Ibadan</option>
                                        <option value="Port Harcourt" {{ in_array('Port Harcourt', old('preferred_regions', [])) ? 'selected' : '' }}>Port Harcourt</option>
                                        <option value="Benin City" {{ in_array('Benin City', old('preferred_regions', [])) ? 'selected' : '' }}>Benin City</option>
                                    </select>
                                    <small class="form-text text-muted">Hold Ctrl/Cmd to select multiple</small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" max="100" class="form-control @error('default_commission_rate') is-invalid @enderror" 
                                           id="default_commission_rate" name="default_commission_rate" value="{{ old('default_commission_rate') }}">
