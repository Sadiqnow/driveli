...
@section('content_header', 'Create New Request')
    ...
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Create New Company Request</h3>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('request_type') is-invalid @enderror" id="request_type" name="request_type">
                            ...
                            <option value="hire" {{ old('request_type') == 'hire' ? 'selected' : '' }}>Hire Driver</option>
                            <option value="replacement" {{ old('request_type') == 'replacement' ? 'selected' : '' }}>Driver Replacement</option>
                            <option value="general" {{ old('request_type') == 'general' ? 'selected' : '' }}>General Request</option>
                        </select>
                        @error('request_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  placeholder="Enter request details...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
