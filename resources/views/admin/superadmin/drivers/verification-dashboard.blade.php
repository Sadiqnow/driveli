...
@section('title', 'Superadmin - Driver Verification Dashboard')
    ...
    <div class="row">
                    ...
                    <div class="row">
                                    ...
                                    @if($driver->documents && $driver->documents->count() > 0)
                                        ...
                                        <div class="col-12">
                                            <small class="text-muted">
                                                ...
                                                <a href="{{ route('admin.superadmin.drivers.documents', $driver->id) }}" class="ms-2">View All</a>
                                            </small>
                                        </div>
                                        @endif
                                    @else
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="verification-actions mb-3">
                                <form method="POST" action="{{ route('admin.superadmin.drivers.verify', $driver->id) }}" class="mb-2">
                                    @csrf
                            ...
                            <div class="quick-actions">
                                ...
                                <div class="btn-group-vertical w-100">
                                    <a href="{{ route('admin.superadmin.drivers.show', $driver->id) }}"
                                       class="btn btn-outline-primary btn-sm">
                                        <i class="fas fa-eye"></i> View Full Profile
                                    </a>
                                    <a href="{{ route('admin.superadmin.drivers.documents', $driver->id) }}"
        ...
        <div class="col-12">
            <div class="text-center py-5">
                ...
                <a href="{{ route('admin.superadmin.drivers.index') }}" class="btn btn-primary">
...
function showRejectModal(driverId, driverName) {
    ...
    $('#rejectForm').attr('action', `/admin/superadmin/drivers/${driverId}/reject`);
...
function flagForReview() {
    ...
    if (selectedDrivers.length > 0) {
        $.post('/admin/superadmin/drivers/bulk-flag-review', {
...
function flagForReviewSingle(driverId) {
    $.post('/admin/superadmin/drivers/flag-review', {
        driver_id: driverId,
        _token: $('meta[name="csrf-token"]').attr('content')
    }).done(function(response) {
...
function saveVerificationNotes(driverId, notes) {
    $.post('/admin/superadmin/drivers/save-verification-notes', {
        driver_id: driverId,
        notes: notes,
        _token: $('meta[name="csrf-token"]').attr('content')
    }).done(function(response) {
